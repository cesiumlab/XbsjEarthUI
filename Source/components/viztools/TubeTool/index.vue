    ...
    <div class="xbsj-flatten">
      ...
      <!-- <div class="flatten">
        ...
        <div class="flatten-box">
          <XbsjLngLatHeight v-model="model.positions"></XbsjLngLatHeight>
        </div>
      </div>-->
      ...
      <div class="flatten">
        <!-- 移动速度 -->
        <label>{{lang.movespeed}}</label>
        <div class="flatten-box">
          <XbsjInputNumber style="float:left; width: calc(50% - 87px);" v-model="model.speed[0]"></XbsjInputNumber>
        </div>
        <!-- 旋转速度 -->
        <label>{{lang.rotatespeed}}</label>
        <div class="flatten-box">
          <XbsjInputNumber style="float:left; width: calc(50% - 87px);" v-model="model.speed[1]"></XbsjInputNumber>
        </div>
      </div>

      <div class="flatten">
        <!-- 径向段 -->
        <label>{{lang.radialsegments}}</label>
        <div class="flatten-box">
          <XbsjInputNumber
            style="float:left; width: calc(50% - 87px);"
            v-model="model.radialSegments"
          ></XbsjInputNumber>
        </div>
        <!-- 管段 -->
        <label>{{lang.tubularsegments}}</label>
        <div class="flatten-box">
          <XbsjInputNumber
            style="float:left; width: calc(50% - 87px);"
            v-model="model.tubularSegments"
          ></XbsjInputNumber>
        </div>
      </div>
      ...
      <div class="flatten">
        ...
        <div class="flatten-box">
          <XbsjSwitch v-model="model.closed"></XbsjSwitch>
        </div>
      </div>
    </div>
  </Window>
...
export default {
  ...
  methods: {
    ...
    ok() {
      ...
      modelToolObj.imageUrl = this.model.imageUrl;
      if (!modelToolObj) {
        return;
      }
      modelToolObj.positionEditing = false;
