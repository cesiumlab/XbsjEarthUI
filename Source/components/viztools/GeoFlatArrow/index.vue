    ...
    <div class="xbsj-flatten">
      ...
      <div class="flatten-flex">
        ...
        <div class="flatten" style="margin-top:10px;">
          <label>{{lang.minwidthscale}}</label>
          <div class="field">
            <XbsjSlider
              :min="0.04"
              :max="0.1"
              :step="0.01"
              showTip="always"
              v-model="model.minWidthScale"
            ></XbsjSlider>
          </div>
        </div>
        <!-- 宽幅比例 -->
        <div class="flatten" style="margin-top:10px;">
          <label>{{lang.dynamicwidthscale}}</label>
          <div class="field">
            <XbsjSlider
              :min="0.00"
              :max="0.2"
              :step="0.01"
              showTip="always"
              v-model="model.dynamicWidthScale"
            ></XbsjSlider>
          </div>
        </div>
      </div>
      <div class="flatten-flex">
        <!-- 箭头高度比例 -->
        <div class="flatten" style="margin-top:10px;">
          <label>{{lang.arrowmaxheightscale}}</label>
          <div class="field">
            <XbsjSlider
              :min="0.05"
              :max="0.2"
              :step="0.01"
              showTip="always"
              v-model="model.arrowMaxHeightScale"
            ></XbsjSlider>
          </div>
        </div>
        <!-- 箭头宽度比例 -->
        <div class="flatten" style="margin-top:10px;">
          <label>{{lang.arrowwingwidthscale}}</label>
          <div class="field">
            <XbsjSlider
              :min="1.8"
              :max="5.0"
              :step="0.1"
              showTip="always"
              v-model="model.arrowWingWidthScale"
            ></XbsjSlider>
          </div>
        </div>
      </div>
