    ...
    <div class="xbsj-flatten">
      ...
      <div class="flatten">
        ...
        <div class="flatten-box">
          <XbsjInputNumber
            style="float:left; width: calc(33.3% - 84px);"
            v-model.number="model.imageWidthScale"
          ></XbsjInputNumber>
        </div>
      </div>
      ...
      <div class="flatten">
        ...
        <div class="flatten-box">
          <input style="float:left; width: calc(50% - 90px);" v-model="model.imageUrl" />
        </div>
        <!-- 纹理高度 -->
        <label>{{lang.imageheight}}</label>
        <div class="flatten-box">
          <XbsjInputNumber
      ...
      <div class="flatten-flex">
        <!-- 鼠标点选 -->
        <div class="flatten">
          <label>{{lang.innerweizhi}}</label>
          <div class="buttonGroup">
            <button
              class="attitudeEditCameraButton"
              @click="model.innerCreating =!model.innerCreating"
              :class="model.innerCreating?'btncoloron':''"
            >{{lang.innercreating}}</button>
            <button
              style="margin-left:20px;"
              class="attitudeEditCameraButton"
              @click="model.innerEditing =!model.innerEditing"
              :class="model.innerEditing?'btncoloron':''"
            >{{lang.innerediting}}</button>
            <button
              style="margin-left:20px;"
              class="attitudeEditCameraButton"
              @click="model.textureRotationEditing =!model.textureRotationEditing"
              :class="model.textureRotationEditing?'btncoloron':''"
