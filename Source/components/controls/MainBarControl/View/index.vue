  ...
  <div class="xbsj-template">
    ...
    >
      <div class="xbsj-list-item">
        ...
        <div class="xbsj-item-blocks">
          <div class="xbsj-item-btnbox ml20" @click="layerShow = !layerShow">
            <div
              class="xbsj-item-btn layerbutton"
              :class="layerShow ? 'layerbuttonActive' : ''"
            ></div>
        ...
        <div class="xbsj-item-blocks">
          <div
            ...
            @click="navcontrolShow = !navcontrolShow"
          >
            <div
              class="xbsj-item-btn navbutton"
              :class="navcontrolShow ? 'navbuttonActive' : ''"
            ></div>
        ...
        <div class="xbsj-item-blocks">
          <div
            class="xbsj-item-btnbox"
            @click="scalecontrolShow = !scalecontrolShow"
          >
            <div
        ...
        <div class="xbsj-item-blocks">
          <div
            class="xbsj-item-btnbox"
            @click="statecontrolShow = !statecontrolShow"
          >
            <div
        ...
        <div class="xbsj-item-blocks">
          <div
            class="xbsj-item-btnbox"
            @click="timelinecontrolShow = !timelinecontrolShow"
          >
            <div
        ...
        <div class="xbsj-item-blocks">
          <div class="xbsj-item-btnbox" @click="tilesTestShow = !tilesTestShow">
            <div
              class="xbsj-item-btn testbutton"
              :class="{ highlight: tilesTestShow }"
            ></div>
        ...
        <div class="xbsj-item-blocks"
          ...
          >
            <div
              ...
              :class="
                splitX > 0 && splitX < 1 && !(splitY > 0 && splitY < 1)
      ...
      <div class="xbsj-list-item xbsj-list-lastitem">
        ...
        <div class="xbsj-item-blocks">
          <div
            class="xbsj-item-btnbox ml20"
            @click="terrainDebug = !terrainDebug"
          >
            <div
        ...
        <div class="xbsj-item-blocks">
          <div class="xbsj-item-btnbox" @click="cesiumDebug = !cesiumDebug">
            <div
              class="xbsj-item-btn dtilesbutton"
              :class="cesiumDebug ? 'dtilesbuttonActive' : ''"
            ></div>
        ...
        <div class="xbsj-item-blocks">
          <div class="xbsj-item-btnbox" @click="tokenUIShow = !tokenUIShow">
            <div
              class="xbsj-item-btn tokenbutton"
              :class="tokenUIShow ? 'tokenbuttonActive' : ''"
            ></div>
    ...
    <div class="xbsj-mainbar-popup popup" v-show="popup">
      <div class="xbsj-item-blocks">
        <div
          class="xbsj-item-btnbox ml20"
          @click="viewportshow('0'), setViewport(1.0, 1.0)"
        >
      ...
      <div class="xbsj-item-blocks">
        <div
          class="xbsj-item-btnbox ml20"
          @click="viewportshow('1'), setViewport(0.5, 1.0)"
        >
      ...
      <div class="xbsj-item-blocks">
        <div
          class="xbsj-item-btnbox"
          @click="viewportshow('2'), setViewport(1.0, 0.5)"
        >
      ...
      <div class="xbsj-item-blocks">
        <div
          class="xbsj-item-btnbox"
          @click="viewportshow('3'), setViewport(0.5, 0.5)"
        >
